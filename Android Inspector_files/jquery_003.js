...
(function () {
    ...
    oException_messages["XPTY0004"] =
    "Type is not appropriate for the context in which the expression occurs";
    oException_messages["XPST0008"] =
    "Expression refers to an element name, attribute name, schema type name, namespace prefix, or variable name that is not defined in the static context";
    oException_messages["XPST0010"] = "Axis not supported";
    oException_messages["XPST0017"] =
    "Expanded QName and number of arguments in a function call do not match the name and arity of a function signature";
    oException_messages["XPTY0018"] =
    "The result of the last step in a path expression contains both nodes and atomic values";
    oException_messages["XPTY0019"] =
    "The result of a step (other than the last step) in a path expression contains an atomic value.";
    oException_messages["XPTY0020"] = "In an axis step, the context item is not a node.";
    oException_messages["XPST0051"] =
    ...
    oException_messages["XPST0081"] =
    "A QName used in an expression contains a namespace prefix that cannot be expanded into a namespace URI by using the statically known namespaces.";
    oException_messages["FORG0001"] = "Invalid value for cast/constructor.";
    oException_messages["FORG0003"] =
    ...
    function cDynamicContext(oStaticContext, vItem, oScope, oDOMAdapter) {
        ...
        this.dateTime =
        new cXSDateTime(oDate.getFullYear(), oDate.getMonth() + 1, oDate.getDate(),
                        oDate.getHours(), oDate.getMinutes(),
                        oDate.getSeconds() + oDate.getMilliseconds() / 1000, -nOffset);
        this.timezone =
        new cXSDayTimeDuration(0, cMath.abs(~~(nOffset / 60)), cMath.abs(nOffset % 60), 0,
                               nOffset > 0);
    };
    ...
    cStaticContext.prototype.getDataType = function (sUri) {
        var aMatch = sUri.match(rStaticContext_uri);
        if (aMatch) {
            return aMatch[1] == sNS_XSD ? hStaticContext_dataTypes[cRegExp.$2]
                : this.dataTypes[sUri];
        }
    };
    ...
    cStaticContext.prototype.getFunction = function (sUri) {
        var aMatch = sUri.match(rStaticContext_uri);
        if (aMatch) {
            return aMatch[1] == sNS_XPF ? hStaticContext_functions[cRegExp.$2]
                : this.functions[sUri];
        }
    };
    ...
    cStaticContext.prototype.getURIForPrefix = function (sPrefix) {
        var oResolver = this.namespaceResolver,
            fResolver = oResolver && oResolver.lookupNamespaceURI ? oResolver.lookupNamespaceURI
                : oResolver,
            sNameSpaceURI;
    ...
    cStaticContext.js2xs = function (vItem) {
        if (typeof vItem == "boolean") {
            ...
            vItem =
            (fIsNaN(vItem) || !fIsFinite(vItem)) ? new cXSDouble(vItem)
                : fNumericLiteral_parseValue(cString(vItem));
        }
        else {
    ...
    cForExpr.prototype.evaluate = function (oContext) {
        ...
        (function (oSelf, nBinding) {
            var oBinding = oSelf.bindings[nBinding++],
                ...
                sUri = (oBinding.namespaceURI ? '{' + oBinding.namespaceURI + '}' : '')
                    + oBinding.localName;
    ...
    function fSimpleForBinding_parse(oLexer, oStaticContext) {
        ...
        return new cSimpleForBinding(aMatch[1] || null, aMatch[2],
    ...
    cIfExpr.prototype.evaluate = function (oContext) {
        return this[fFunction_sequence_toEBV(this.condExpr.evaluate(oContext), oContext)
            ? "thenExpr" : "elseExpr"].evaluate(oContext);
    };
    ...
    function fSimpleQuantifiedBinding_parse(oLexer, oStaticContext) {
        ...
        return new cSimpleQuantifiedBinding(aMatch[1] || null, aMatch[2],
                                            aMatch[1] ? oStaticContext.getURIForPrefix(aMatch[1])
                                                : null, oExpr);
    };
    ...
    hComparisonExpr_ValueComp_operators['eq'] = function (oLeft, oRight, oContext) {
        ...
        if (fXSAnyAtomicType_isNumeric(oLeft)) {
            ...
            if (oRight instanceof cXSString) {
                return hStaticContext_operators["numeric-equal"].call(oContext,
                                                                      hStaticContext_functions["compare"].call(oContext,
                                                                                                               oLeft,
                                                                                                               oRight),
                                                                      new cXSInteger(0));
            }
    ...
    hComparisonExpr_ValueComp_operators['ne'] = function (oLeft, oRight, oContext) {
        return new cXSBoolean(!hComparisonExpr_ValueComp_operators['eq'](oLeft, oRight,
                                                                         oContext).valueOf());
    };
    hComparisonExpr_ValueComp_operators['gt'] = function (oLeft, oRight, oContext) {
        ...
        if (fXSAnyAtomicType_isNumeric(oLeft)) {
            ...
            if (oRight instanceof cXSString) {
                return hStaticContext_operators["numeric-greater-than"].call(oContext,
                                                                             hStaticContext_functions["compare"].call(oContext,
                                                                                                                      oLeft,
                                                                                                                      oRight),
                                                                             new cXSInteger(0));
    ...
    hComparisonExpr_ValueComp_operators['lt'] = function (oLeft, oRight, oContext) {
        ...
        if (fXSAnyAtomicType_isNumeric(oLeft)) {
            ...
            if (oRight instanceof cXSString) {
                return hStaticContext_operators["numeric-less-than"].call(oContext,
                                                                          hStaticContext_functions["compare"].call(oContext,
                                                                                                                   oLeft,
                                                                                                                   oRight),
                                                                          new cXSInteger(0));
    ...
    hComparisonExpr_ValueComp_operators['ge'] = function (oLeft, oRight, oContext) {
        ...
        if (fXSAnyAtomicType_isNumeric(oLeft)) {
            if (fXSAnyAtomicType_isNumeric(oRight)) {
                return hStaticContext_operators["numeric-greater-than"].call(oContext, oLeft,
                                                                             oRight)
        ...
        if (sOperator) {
            return new cXSBoolean(!hStaticContext_operators[sOperator].call(oContext, oLeft,
                                                                            oRight).valueOf());
        }
    ...
    hAdditiveExpr_operators['+'] = function (oLeft, oRight, oContext) {
        ...
        if (sOperator) {
            return hStaticContext_operators[sOperator].call(oContext, bReverse ? oRight : oLeft,
                                                            bReverse ? oLeft : oRight);
        }
    ...
    cAdditiveExpr.prototype.evaluate = function (oContext) {
        ...
        for (var nIndex = 0, nLength = this.items.length, oRight, vRight; nIndex < nLength;
             nIndex++) {
    ...
    cStepExpr.prototype.applyPredicates = function (oSequence, oContext) {
        ...
        for (var nPredicateIndex = 0, oSequence1, nPredicateLength = this.predicates.length;
             nPredicateIndex < nPredicateLength; nPredicateIndex++) {
            oSequence1 = oSequence;
            oSequence = [];
            for (var nIndex = 0, oSequence2, nLength = oSequence1.length; nIndex < nLength;
                 nIndex++) {
    ...
    function fAxisStep_parse(oLexer, oStaticContext) {
        ...
        if (oLexer.peek(1) == '::') {
            ...
            oStep =
            new cAxisStep(oExpr instanceof cKindTest && oExpr.name == "attribute" ? "attribute"
                              : "child", oExpr);
        }
    ...
    cAxisStep.prototype.evaluate = function (oContext) {
        ...
        switch (this.axis) {
            case "attribute":
                if (nType == 1) {
                    for (var aAttributes = fGetProperty(oItem,
                                                        "attributes"), nIndex = 0, nLength = aAttributes.length;
            ...
            case "child":
                for (var oNode = fGetProperty(oItem, "firstChild"); oNode;
                     oNode = fGetProperty(oNode, "nextSibling")) {
            ...
            case "descendant":
                fAxisStep_getChildrenForward(fGetProperty(oItem, "firstChild"), oSequence,
                                             fGetProperty);
                break;

            case "following":
                for (var oParent = oItem, oSibling; oParent;
                     oParent = fGetProperty(oParent, "parentNode")) {
            ...
            case "ancestor-or-self":
                oSequence.push(oItem);
            case "ancestor":
                for (var oNode = nType == 2 ? fGetProperty(oItem, "ownerElement") : oItem;
                     oNode = fGetProperty(oNode, "parentNode");) {
                    oSequence.push(oNode);
                }
                break;

            case "parent":
                var oParent = nType == 2 ? fGetProperty(oItem, "ownerElement") : fGetProperty(oItem,
                                                                                              "parentNode");
                if (oParent) {
    ...
    cPathExpr.prototype.evaluate = function (oContext) {
        ...
        for (var nItemIndex = 0, nItemLength = this.items.length, oSequence1;
            ...
            for (var nIndex = 0, nLength = oSequence.length; nIndex < nLength; nIndex++) {
                ...
                for (var nRightIndex = 0, oSequence2 = this.items[nItemIndex].evaluate(oContext), nRightLength = oSequence2.length;
                     nRightIndex < nRightLength; nRightIndex++) {
    ...
    cKindTest.prototype.test = function (oNode, oContext) {
        ...
        if (nType == 2) {
            return fGetProperty(oNode, "prefix") != "xmlns" && fGetProperty(oNode, "localName")
                != "xmlns";
        }
        if (nType == 7) {
...
//    var rNameTest = /^(?:(?![0-9-])([\w-]+|\*)\:)?(?![0-9-])([\w-]+|\*)$/;
    ...
    function fNameTest_parse(oLexer, oStaticContext) {
        ...
        if (aMatch) {
            ...
            oLexer.next();
            return new cNameTest(aMatch[1] || null, aMatch[2], aMatch[1] ? aMatch[1] == '*' ? '*'
                : oStaticContext.getURIForPrefix(aMatch[1]) || null
    ...
    cNameTest.prototype.test = function (oNode, oContext) {
        ...
        if (nType == 1 || nType == 2) {
            if (this.localName == '*') {
                return (nType == 1 || (fGetProperty(oNode, "prefix") != "xmlns"
                    && fGetProperty(oNode, "localName") != "xmlns")) && (!this.prefix
                    || fGetProperty(oNode, "namespaceURI") == this.namespaceURI);
            }
            if (this.localName == fGetProperty(oNode, "localName")) {
                return this.namespaceURI == '*' || (nType == 2 && !this.prefix
                    && !fGetProperty(oNode, "prefix")) || fGetProperty(oNode, "namespaceURI")
                           == this.namespaceURI;
            }
        }
        return false;
    ...
    function fStringLiteral_parse(oLexer, oStaticContext) {
        ...
        if (aMatch) {
            oLexer.next();
            return new cStringLiteral(new cXSString(aMatch[1] ? aMatch[1].replace("''", "'")
                                                        : aMatch[2] ? aMatch[2].replace('""', '"')
                                                        : ''));
        }
    };
    ...
    cVarRef.prototype.evaluate = function (oContext) {
        ...
        throw new cException("XPST0008"
            , "Variable $" + (this.prefix ? this.prefix + ':' : '') + this.localName
    ...
    function fFunctionCall_parse(oLexer, oStaticContext) {
        ...
        if (aMatch && oLexer.peek(1) == '(') {
            ...
            var oFunctionCallExpr = new cFunctionCall(aMatch[1] || null, aMatch[2], aMatch[1]
                    ? oStaticContext.getURIForPrefix(aMatch[1]) || null
    ...
    cFunctionCall.prototype.evaluate = function (oContext) {
        ...
        if (this.namespaceURI == sNS_XPF) {
            ...
            if ((fFunction = hStaticContext_dataTypes[this.localName]) && this.localName
                != "NOTATION" && this.localName != "anyAtomicType") {
    ...
    function fFunctionCall_prepare(sName, aParameters, fFunction, aArguments, oContext) {
        ...
        if (nArgumentsLength > nParametersLength) {
            throw new cException("XPST0017"
                , "Function " + sName + "() must have " + (nParametersLength ? " no more than "
                    : '') + nParametersLength + " argument" + (nParametersLength > 1
                                                                   || !nParametersLength ? 's' : '')
            );
        }
        else if (nArgumentsLength < nParametersRequired) {
            throw new cException("XPST0017"
                , "Function " + sName + "() must have " + (nParametersRequired == nParametersLength
                    ? "exactly" : "at least") + ' ' + nParametersRequired + " argument"
                                     + (nParametersLength > 1 ? 's' : '')
            );
        }
    ...
    function fFunctionCall_assertSequenceItemType(oContext, oSequence, cItemType, sSource) {
        for (var nIndex = 0, nLength = oSequence.length, nNodeType, vItem; nIndex < nLength;
             nIndex++) {
            ...
            if (cItemType == cXTNode || cItemType.prototype instanceof cXTNode) {
                ...
                if (cItemType != cXTNode) {
                    ...
                    if ([null, cXTElement, cXTAttribute, cXTText, cXTText, null, null,
                         cXTProcessingInstruction, cXTComment, cXTDocument, null, null, null
                        ][nNodeType] != cItemType) {
                        throw new cException("XPTY0004"
                            , "Required item type of " + sSource + " is " + cItemType
                        );
            ...
            else if (cItemType == cXSAnyAtomicType || cItemType.prototype
                instanceof cXSAnyAtomicType) {
    ...
    cIntersectExceptExpr.prototype.evaluate = function (oContext) {
        ...
        for (var nIndex = 0, nLength = this.items.length, oItem; nIndex < nLength; nIndex++) {
            oSequence =
            hStaticContext_operators[(oItem = this.items[nIndex])[0]].call(oContext, oSequence,
                                                                           oItem[1].evaluate(oContext));
        }
        return oSequence;
    };
    ...
    cTreatExpr.prototype.evaluate = function (oContext) {
        ...
        for (var nIndex = 0, nLength = oSequence1.length; nIndex < nLength; nIndex++) {
            if (!oItemType.test.test(oSequence1[nIndex], oContext)) {
                throw new cException("XPDY0050"
                    , "Required item type of value in 'treat as' expression is "
                          + (oItemType.test.prefix ? oItemType.test.prefix + ':' : '')
        ...
        try {
            ...
            if (e.code == "XPST0017") {
                throw new cException("XPST0080"
                    , "No value is castable to " + (oItemType.prefix ? oItemType.prefix + ':' : '')
                                         + oItemType.localName
                );
            }
            return [new cXSBoolean(false)];
    ...
    cCastExpr.prototype.evaluate = function (oContext) {
        ...
        return [
            this.type.itemType.cast(fFunction_sequence_atomize(oSequence1, oContext)[0], oContext)];
    };
    ...
    function fAtomicType_parse(oLexer, oStaticContext) {
        ...
        if (aMatch) {
            ...
            oLexer.next();
            return new cAtomicType(aMatch[1] || null, aMatch[2],
                                   aMatch[1] ? oStaticContext.getURIForPrefix(aMatch[1]) : null);
        }
    };
    ...
    cAtomicType.prototype.test = function (vItem, oContext) {
        var sUri = (this.namespaceURI ? '{' + this.namespaceURI + '}' : '') + this.localName,
            cType = this.namespaceURI == sNS_XSD ? hStaticContext_dataTypes[this.localName]
                : oContext.staticContext.getDataType(sUri);
        if (cType) {
    ...
    function fXSAnyAtomicType_isNumeric(vItem) {
        return vItem instanceof cXSFloat || vItem instanceof cXSDouble || vItem
            instanceof cXSDecimal;
    };
    ...
    cXSBase64Binary.cast = function (vValue) {
        ...
        if (vValue instanceof cXSHexBinary) {
            throw "Casting from 'xs:" + "hexBinary" + "' to 'xs:" + "base64Binary"
                + "' not implemented";
        }
        throw new cException("XPTY0004"
            ...
            if (aMatch) {
                ...
                if (nDay - 1 < fXSDate_getDaysForYearMonth(nYear, nMonth)) {
                    return new cXSDate(nYear,
                                       nMonth,
                                       nDay,
                                       aMatch[5] ? aMatch[5] == 'Z' ? 0 : (aMatch[6] == '-' ? -1
                                           : 1) * (aMatch[7] * 60 + aMatch[8] * 1) : null,
                                       aMatch[1] == '-'
                    );
                }
                throw new cException("FORG0001"
    ...
    function fXSDate_getDaysForYearMonth(nYear, nMonth) {
        return nMonth == 2 && (nYear % 400 == 0 || nYear % 100 != 0 && nYear % 4 == 0) ? 29
            : aXSDate_days[nMonth - 1];
    };
            ...
            if (aMatch) {
                ...
                if (nDay - 1 < fXSDate_getDaysForYearMonth(nYear, nMonth)) {
                    return fXSDateTime_normalize(new cXSDateTime(nYear,
                                                                 ...
                                                                 bValue ? 24 : +aMatch[6],
                                                                 bValue ? 0 : +aMatch[7],
                                                                 cNumber((bValue ? 0 : aMatch[8])
                                                                             + '.' + (bValue ? 0
                                                                     : aMatch[9] || 0)),
                                                                 aMatch[12] ? aMatch[12] == 'Z' ? 0
                                                                     : (aMatch[13] == '-' ? -1 : 1)
                                                                                  * (aMatch[14] * 60
                                                                     + aMatch[15] * 1) : null,
                                                                 aMatch[1] == '-'
    ...
    function fXSDateTime_pad(vValue, nLength) {
        ...
        return (sValue.length < nLength + 1 ? new cArray(nLength + 1 - sValue.length).join('0')
            : '') + sValue;
    };
    ...
    cXSDuration.prototype.toString = function () {
        return (this.negative ? '-' : '') + 'P'
            + ((fXSDuration_getYearMonthComponent(this) + fXSDuration_getDayTimeComponent(this))
            || 'T0S');
    };
    ...
    cXSDuration.cast = function (vValue) {
        ...
        if (vValue instanceof cXSDayTimeDuration) {
            return new cXSDuration(0, 0, vValue.day, vValue.hours, vValue.minutes, vValue.seconds,
                                   vValue.negative);
        }
        ...
        if (vValue instanceof cXSString || vValue instanceof cXSUntypedAtomic) {
            ...
            if (aMatch) {
                return fXSDuration_normalize(new cXSDuration(+aMatch[2] || 0, +aMatch[3] || 0,
                                                             +aMatch[4] || 0, +aMatch[5] || 0,
                                                             +aMatch[6] || 0, +aMatch[7] || 0,
                                                             aMatch[1] == '-'));
            }
            throw new cException("FORG0001");
        }
        ...
        if (vValue instanceof cXSString || vValue instanceof cXSUntypedAtomic) {
            ...
            if (aMatch) {
                ...
                return new cXSGDay(nDay,
                                   aMatch[2] ? aMatch[2] == 'Z' ? 0 : (aMatch[3] == '-' ? -1 : 1)
                                       * (aMatch[4] * 60 + aMatch[5] * 1) : null
                );
            }
            throw new cException("FORG0001");
        }
            ...
            if (aMatch) {
                ...
                if (nDay - 1 < fXSDate_getDaysForYearMonth(1976, nMonth)) {
                    return new cXSGMonthDay(nMonth,
                                            nDay,
                                            aMatch[3] ? aMatch[3] == 'Z' ? 0 : (aMatch[4] == '-'
                                                ? -1 : 1) * (aMatch[5] * 60 + aMatch[6] * 1) : null
                    );
                }
                throw new cException("FORG0001"
                    , "Invalid date '" + vValue + "' (Non-existent date)"
        ...
        if (vValue instanceof cXSString || vValue instanceof cXSUntypedAtomic) {
            ...
            if (aMatch) {
                ...
                return new cXSGYearMonth(nYear,
                                         nMonth,
                                         aMatch[3] ? aMatch[3] == 'Z' ? 0 : (aMatch[4] == '-' ? -1
                                             : 1) * (aMatch[5] * 60 + aMatch[6] * 1) : null
                );
            }
            throw new cException("FORG0001");
        }
    ...
    cXSHexBinary.cast = function (vValue) {
        ...
        if (vValue instanceof cXSBase64Binary) {
            throw "Casting from 'xs:" + "base64Binary" + "' to 'xs:" + "hexBinary"
                + "' not implemented";
        }
        throw new cException("XPTY0004"
            , "Casting value '" + vValue + "' to xs:hexBinary can never succeed"
        ...
        if (vValue instanceof cXSString || vValue instanceof cXSUntypedAtomic) {
            ...
            if (aMatch) {
                ...
                return new cXSTime(bValue ? 0 : +aMatch[2],
                                   bValue ? 0 : +aMatch[3],
                                   cNumber((bValue ? 0 : aMatch[4]) + '.' + (bValue ? 0 : aMatch[5]
                                       || 0)),
                                   aMatch[8] ? aMatch[8] == 'Z' ? 0 : (aMatch[9] == '-' ? -1 : 1)
                                       * (aMatch[10] * 60 + aMatch[11] * 1) : null
                );
            }
            throw new cException("FORG0001");
        }
    ...
    function fXSTime_normalize(oValue) {
        if (oValue.seconds >= 60 || oValue.seconds < 0) {
            oValue.minutes +=
            ~~(oValue.seconds / 60) - (oValue.seconds < 0 && oValue.seconds % 60 ? 1 : 0);
            oValue.seconds =
            oValue.seconds % 60 + (oValue.seconds < 0 && oValue.seconds % 60 ? 60 : 0);
        }
        if (oValue.minutes >= 60 || oValue.minutes < 0) {
            oValue.hours +=
            ~~(oValue.minutes / 60) - (oValue.minutes < 0 && oValue.minutes % 60 ? 1 : 0);
            oValue.minutes =
            oValue.minutes % 60 + (oValue.minutes < 0 && oValue.minutes % 60 ? 60 : 0);
        }
        if (oValue.hours >= 24 || oValue.hours < 0) {
            if (oValue instanceof cXSDateTime) {
                oValue.day +=
                ~~(oValue.hours / 24) - (oValue.hours < 0 && oValue.hours % 24 ? 1 : 0);
            }
    ...
    cXSYearMonthDuration.cast = function (vValue) {
        ...
        if (vValue instanceof cXSString || vValue instanceof cXSUntypedAtomic) {
            ...
            if (aMatch) {
                return fXSYearMonthDuration_normalize(new cXSYearMonthDuration(+aMatch[2] || 0,
                                                                               +aMatch[3] || 0,
                                                                               aMatch[1] == '-'));
            }
            throw new cException("FORG0001");
    ...
    cXSDayTimeDuration.cast = function (vValue) {
        ...
        if (vValue instanceof cXSString || vValue instanceof cXSUntypedAtomic) {
            ...
            if (aMatch) {
                return fXSDayTimeDuration_normalize(new cXSDayTimeDuration(+aMatch[2] || 0,
                                                                           +aMatch[3] || 0,
                                                                           +aMatch[4] || 0,
                                                                           +aMatch[5] || 0,
                                                                           aMatch[1] == '-'));
        ...
        if (vValue instanceof cXSDuration) {
            return new cXSDayTimeDuration(vValue.day, vValue.hours, vValue.minutes, vValue.seconds,
                                          vValue.negative);
        }
        throw new cException("XPTY0004"
    ...
    hStaticContext_operators["yearMonthDuration-less-than"] = function (oLeft, oRight) {
        return new cXSBoolean(fOperator_yearMonthDuration_toMonths(oLeft)
                                  < fOperator_yearMonthDuration_toMonths(oRight));
    };
    ...
    hStaticContext_operators["dayTimeDuration-less-than"] = function (oLeft, oRight) {
        return new cXSBoolean(fOperator_dayTimeDuration_toSeconds(oLeft)
                                  < fOperator_dayTimeDuration_toSeconds(oRight));
    };
    ...
    hStaticContext_operators["duration-equal"] = function (oLeft, oRight) {
        return new cXSBoolean(oLeft.negative == oRight.negative
                                  ...
                                  == fOperator_yearMonthDuration_toMonths(oRight)
                                  && fOperator_dayTimeDuration_toSeconds(oLeft)
                                  == fOperator_dayTimeDuration_toSeconds(oRight));
    };
    ...
    hStaticContext_operators["gYearMonth-equal"] = function (oLeft, oRight) {
        return fOperator_compareDateTimes(
            new cXSDateTime(oLeft.year, oLeft.month,
                            fXSDate_getDaysForYearMonth(oLeft.year, oLeft.month), 0, 0, 0,
                            oLeft.timezone == null ? this.timezone : oLeft.timezone),
            new cXSDateTime(oRight.year, oRight.month,
                            fXSDate_getDaysForYearMonth(oRight.year, oRight.month), 0, 0, 0,
                            oRight.timezone == null ? this.timezone : oRight.timezone),
            'eq'
        );
    };
    ...
    hStaticContext_operators["gYear-equal"] = function (oLeft, oRight) {
        return fOperator_compareDateTimes(
            new cXSDateTime(oLeft.year, 1, 1, 0, 0, 0,
                            oLeft.timezone == null ? this.timezone : oLeft.timezone),
            new cXSDateTime(oRight.year, 1, 1, 0, 0, 0,
                            oRight.timezone == null ? this.timezone : oRight.timezone),
            'eq'
        );
    };
    ...
    hStaticContext_operators["gMonthDay-equal"] = function (oLeft, oRight) {
        return fOperator_compareDateTimes(
            new cXSDateTime(1972, oLeft.month, oLeft.day, 0, 0, 0,
                            oLeft.timezone == null ? this.timezone : oLeft.timezone),
            new cXSDateTime(1972, oRight.month, oRight.day, 0, 0, 0,
                            oRight.timezone == null ? this.timezone : oRight.timezone),
            'eq'
        );
    };
    ...
    hStaticContext_operators["gMonth-equal"] = function (oLeft, oRight) {
        return fOperator_compareDateTimes(
            new cXSDateTime(1972, oLeft.month, fXSDate_getDaysForYearMonth(1972, oRight.month), 0,
                            0, 0, oLeft.timezone == null ? this.timezone : oLeft.timezone),
            new cXSDateTime(1972, oRight.month, fXSDate_getDaysForYearMonth(1972, oRight.month), 0,
                            0, 0, oRight.timezone == null ? this.timezone : oRight.timezone),
            'eq'
        );
    };
    ...
    hStaticContext_operators["gDay-equal"] = function (oLeft, oRight) {
        return fOperator_compareDateTimes(
            new cXSDateTime(1972, 12, oLeft.day, 0, 0, 0,
                            oLeft.timezone == null ? this.timezone : oLeft.timezone),
            new cXSDateTime(1972, 12, oRight.day, 0, 0, 0,
                            oRight.timezone == null ? this.timezone : oRight.timezone),
            'eq'
        );
    };
    ...
    hStaticContext_operators["add-yearMonthDurations"] = function (oLeft, oRight) {
        return fOperator_yearMonthDuration_fromMonths(fOperator_yearMonthDuration_toMonths(oLeft)
                                                          + fOperator_yearMonthDuration_toMonths(oRight));
    };
    ...
    hStaticContext_operators["divide-yearMonthDuration-by-yearMonthDuration"] =
    function (oLeft, oRight) {
        return new cXSDecimal(fOperator_yearMonthDuration_toMonths(oLeft)
                                  / fOperator_yearMonthDuration_toMonths(oRight));
    };

    hStaticContext_operators["add-dayTimeDurations"] = function (oLeft, oRight) {
        return fOperator_dayTimeDuration_fromSeconds(fOperator_dayTimeDuration_toSeconds(oLeft)
                                                         + fOperator_dayTimeDuration_toSeconds(oRight));
    };
    ...
    hStaticContext_operators["divide-dayTimeDuration-by-dayTimeDuration"] =
    function (oLeft, oRight) {
        return new cXSDecimal(fOperator_dayTimeDuration_toSeconds(oLeft)
                                  / fOperator_dayTimeDuration_toSeconds(oRight));
    };
    ...
    hStaticContext_operators["subtract-times"] = function (oLeft, oRight) {
        return fOperator_dayTimeDuration_fromSeconds(fOperator_time_toSeconds(oLeft)
                                                         - fOperator_time_toSeconds(oRight));
    };
    ...
    hStaticContext_operators["subtract-yearMonthDuration-from-dateTime"] =
    function (oLeft, oRight) {
        return fOperator_addYearMonthDuration2DateTime(oLeft, oRight, '-');
    };
    ...
    function fOperator_compareTimes(oLeft, oRight, sComparator) {
        ...
        return new cXSBoolean(sComparator == 'lt' ? nLeft < nRight : sComparator == 'gt' ? nLeft
            > nRight : nLeft == nRight);
    };

    function fOperator_compareDates(oLeft, oRight, sComparator) {
        return fOperator_compareDateTimes(cXSDateTime.cast(oLeft), cXSDateTime.cast(oRight),
                                          sComparator);
    };
    ...
    function fOperator_compareDateTimes(oLeft, oRight, sComparator) {
        ...
        return new cXSBoolean(sComparator == 'lt' ? sLeft < sRight : sComparator == 'gt' ? sLeft
            > sRight : sLeft == sRight);
    };
    ...
    function fOperator_addYearMonthDuration2DateTime(oLeft, oRight, sOperator) {
        ...
        if (oLeft instanceof cXSDate) {
            oValue =
            new cXSDate(oLeft.year, oLeft.month, oLeft.day, oLeft.timezone, oLeft.negative);
        }
        else if (oLeft instanceof cXSDateTime) {
            oValue =
            new cXSDateTime(oLeft.year, oLeft.month, oLeft.day, oLeft.hours, oLeft.minutes,
                            oLeft.seconds, oLeft.timezone, oLeft.negative);
        }
    ...
    function fOperator_dayTimeDuration_toSeconds(oDuration) {
        return (((oDuration.day * 24 + oDuration.hours) * 60 + oDuration.minutes) * 60
            + oDuration.seconds) * (oDuration.negative ? -1 : 1);
    };
    ...
    function fOperator_time_toSeconds(oTime) {
        return oTime.seconds + (oTime.minutes - (oTime.timezone != null ? oTime.timezone % 60 : 0)
            + (oTime.hours - (oTime.timezone != null ? ~~(oTime.timezone / 60) : 0)) * 60) * 60;
    };
    ...
    function fFunctionCall_numeric_getPower(oLeft, oRight) {
        if (fIsNaN(oLeft) || (cMath.abs(oLeft) == nInfinity) || fIsNaN(oRight) || (cMath.abs(oRight)
            == nInfinity)) {
            return 0;
        }
        var aLeft = cString(oLeft).match(rNumericLiteral),
            aRight = cString(oRight).match(rNumericLiteral),
            nPower = cMath.max(1, (aLeft[2] || aLeft[3] || '').length + (aLeft[5] || 0) * (aLeft[4]
                                                                                               == '+'
                ? -1 : 1), (aRight[2] || aRight[3] || '').length + (aRight[5] || 0) * (aRight[4]
                                                                                           == '+'
                ? -1 : 1));
    ...
    hStaticContext_operators["numeric-add"] = function (oLeft, oRight) {
        ...
        return fOperator_numeric_getResultOfType(oLeft, oRight,
                                                 ((nLeft * nPower) + (nRight * nPower)) / nPower);
    };
    ...
    function fOperator_numeric_getResultOfType(oLeft, oRight, nResult) {
        return new (oLeft instanceof cXSInteger && oRight instanceof cXSInteger && nResult
            == cMath.round(nResult) ? cXSInteger : cXSDecimal)(nResult);
    };

    hStaticContext_operators["QName-equal"] = function (oLeft, oRight) {
        return new cXSBoolean(oLeft.localName == oRight.localName && oLeft.namespaceURI
            == oRight.namespaceURI);
    };
    ...
    hStaticContext_operators["intersect"] = function (oSequence1, oSequence2) {
        var oSequence = [];
        for (var nIndex = 0, nLength = oSequence1.length, oItem, bFound; nIndex < nLength;
             nIndex++) {
            if (!this.DOMAdapter.isNode(oItem = oSequence1[nIndex])) {
                throw new cException("XPTY0004"
    ...
    hStaticContext_operators["to"] = function (oLeft, oRight) {
        var oSequence = [];
        for (var nIndex = oLeft.valueOf(), nLength = oRight.valueOf(); nIndex <= nLength;
             nIndex++) {
    ...
    fStaticContext_defineSystemFunction("node-name", [
        ...
        if (oNode != null) {
            ...
            switch (fGetProperty(oNode, "nodeType")) {
                case 1:
                case 2:
                    return new cXSQName(fGetProperty(oNode, "prefix"),
                                        fGetProperty(oNode, "localName"),
                                        fGetProperty(oNode, "namespaceURI"));
                case 5:
                    throw "Not implemented";
                case 6:
                    throw "Not implemented";
    ...
    fStaticContext_defineSystemFunction("string", [
        ...
        return oItem == null ? new cXSString('') : cXSString.cast(fFunction_sequence_atomize(
            [oItem], this)[0]);
    });
    ...
    fStaticContext_defineSystemFunction("adjust-dateTime-to-timezone", [
        ...
        return fFunction_dateTime_adjustTimezone(oDateTime,
                                                 arguments.length > 1 && oDayTimeDuration != null
                                                     ? arguments.length > 1 ? oDayTimeDuration
                                                     : this.timezone : null);
    });
    ...
    fStaticContext_defineSystemFunction("adjust-date-to-timezone", [
        ...
        return fFunction_dateTime_adjustTimezone(oDate,
                                                 arguments.length > 1 && oDayTimeDuration != null
                                                     ? arguments.length > 1 ? oDayTimeDuration
                                                     : this.timezone : null);
    });
    ...
    fStaticContext_defineSystemFunction("adjust-time-to-timezone", [
        ...
        return fFunction_dateTime_adjustTimezone(oTime,
                                                 arguments.length > 1 && oDayTimeDuration != null
                                                     ? arguments.length > 1 ? oDayTimeDuration
                                                     : this.timezone : null);
    });
    ...
    function fFunction_dateTime_getComponent(oDateTime, sName) {
        ...
        if (sName == "timezone") {
            ...
            return new cXSDayTimeDuration(0, cMath.abs(~~(nTimezone / 60)),
                                          cMath.abs(nTimezone % 60), 0, nTimezone < 0);
        }
        else {
    ...
    function fFunction_dateTime_adjustTimezone(oDateTime, oTimezone) {
        ...
        if (oDateTime instanceof cXSDate) {
            oValue =
            new cXSDate(oDateTime.year, oDateTime.month, oDateTime.day, oDateTime.timezone,
                        oDateTime.negative);
        }
        else if (oDateTime instanceof cXSTime) {
            oValue =
            new cXSTime(oDateTime.hours, oDateTime.minutes, oDateTime.seconds, oDateTime.timezone,
                        oDateTime.negative);
        }
        else {
            oValue =
            new cXSDateTime(oDateTime.year, oDateTime.month, oDateTime.day, oDateTime.hours,
                            oDateTime.minutes, oDateTime.seconds, oDateTime.timezone,
                            oDateTime.negative);
        }
            ...
            if (aAttributes = fGetProperty(oNode, "attributes")) {
                for (var nIndex = 0, nLength = aAttributes.length; nIndex < nLength; nIndex++) {
                    if (fGetProperty(aAttributes[nIndex], "nodeName") == "xml:lang") {
                        return new cXSBoolean(fGetProperty(aAttributes[nIndex],
                                                           "value").replace(/-.+/, '').toLowerCase()
                                                  == sLang.valueOf().replace(/-.+/,
                                                                             '').toLowerCase());
                    }
                }
            }
    ...
    fStaticContext_defineSystemFunction("round-half-to-even", [
        ...
        if (nPrecision < 0) {
            var oPower = new cXSInteger(cMath.pow(10, -nPrecision)),
                nRounded = cMath.round(hStaticContext_operators["numeric-divide"].call(this, oValue,
                                                                                       oPower)),
                oRounded = new cXSInteger(nRounded);
            nDecimal =
            cMath.abs(hStaticContext_operators["numeric-subtract"].call(this, oRounded,
                                                                        hStaticContext_operators["numeric-divide"].call(this,
                                                                                                                        oValue,
                                                                                                                        oPower)));
            return hStaticContext_operators["numeric-multiply"].call(this,
                                                                     hStaticContext_operators["numeric-add"].call(this,
                                                                                                                  oRounded,
                                                                                                                  new cXSDecimal(nDecimal
                                                                                                                                     == 0.5
                                                                                                                                     && nRounded
                                                                                                                                     % 2
                                                                                                                                     ? -1
            ...
            var oPower = new cXSInteger(cMath.pow(10, nPrecision)),
                nRounded = cMath.round(hStaticContext_operators["numeric-multiply"].call(this,
                                                                                         oValue,
                                                                                         oPower)),
                oRounded = new cXSInteger(nRounded);
            nDecimal =
            cMath.abs(hStaticContext_operators["numeric-subtract"].call(this, oRounded,
                                                                        hStaticContext_operators["numeric-multiply"].call(this,
                                                                                                                          oValue,
                                                                                                                          oPower)));
            return hStaticContext_operators["numeric-divide"].call(this,
                                                                   hStaticContext_operators["numeric-add"].call(this,
                                                                                                                oRounded,
                                                                                                                new cXSDecimal(nDecimal
                                                                                                                                   == 0.5
    ...
    fStaticContext_defineSystemFunction("index-of", [
        ...
        var oSequence = [];
        for (var nIndex = 0, nLength = oSequence1.length, vValue = oSearch.valueOf();
             nIndex < nLength; nIndex++) {
    ...
    fStaticContext_defineSystemFunction("distinct-values", [
        ...
        for (var nIndex = 0, nLength = oSequence1.length, vValue; nIndex < nLength; nIndex++) {
            ...
            for (var nRightIndex = 0, nRightLength = oSequence.length, bFound = false;
                 (nRightIndex < nRightLength) && !bFound; nRightIndex++) {
    ...
    fStaticContext_defineSystemFunction("subsequence", [
        ...
        var nPosition = cMath.round(oStart),
            nLength = arguments.length > 2 ? cMath.round(oLength) : oSequence1.length - nPosition
                + 1;
    ...
    fStaticContext_defineSystemFunction("max", [
        ...
        try {
            ...
            for (var nIndex = 1, nLength = oSequence1.length; nIndex < nLength; nIndex++) {
                if (hComparisonExpr_ValueComp_operators['ge'](oSequence1[nIndex], vValue,
                                                              this).valueOf()) {
    ...
    fStaticContext_defineSystemFunction("min", [
        ...
        try {
            var vValue = oSequence1[0];
            for (var nIndex = 1, nLength = oSequence1.length; nIndex < nLength; nIndex++) {
                if (hComparisonExpr_ValueComp_operators['le'](oSequence1[nIndex], vValue,
                                                              this).valueOf()) {
                    vValue = oSequence1[nIndex];
                }
            }
    ...
    fStaticContext_defineSystemFunction("id", [
        ...
        for (var nIndex = 0; nIndex < oSequence1.length; nIndex++) {
            for (var nRightIndex = 0, aValue = fString_trim(oSequence1[nIndex]).split(/\s+/), nRightLength = aValue.length;
                 nRightIndex < nRightLength; nRightIndex++) {
                if ((oNode = this.DOMAdapter.getElementById(oDocument, aValue[nRightIndex]))
                    && fArray_indexOf(oSequence, oNode) == -1) {
                    oSequence.push(oNode);
                }
            }
        }
    ...
    function fFunction_sequence_atomize(oSequence1, oContext) {
        var oSequence = [];
        for (var nIndex = 0, nLength = oSequence1.length, oItem, vItem; nIndex < nLength;
             nIndex++) {
            ...
            if (oItem == null) {
                ...
                switch (fGetProperty(oItem, "nodeType")) {
                    ...
                    case 9:
                        ...
                        vItem =
                        new cXSUntypedAtomic(oNode ? fGetProperty(oNode, "textContent") : '');
                        break;
                }
            }
    ...
    fStaticContext_defineSystemFunction("compare", [
        ...
        vCollation =
        sCollation == sNS_XPF + "/collation/codepoint" ? oCodepointStringCollator
            : this.staticContext.getCollation(sCollation);
        if (!vCollation) {
    ...
    fStaticContext_defineSystemFunction("concat", null, function () {
        ...
        for (var nIndex = 0, nLength = arguments.length, oSequence; nIndex < nLength; nIndex++) {
            ...
            if (oSequence.length) {
                ...
                cXSString.cast(fFunction_sequence_atomize(oSequence, this)[0]).valueOf();
            }
        }
    ...
    fStaticContext_defineSystemFunction("contains", [
        ...
        return new cXSBoolean((oValue == null ? '' : oValue.valueOf()).indexOf(oSearch == null ? ''
                                                                                   : oSearch.valueOf())
                                  >= 0);
    });
    ...
    fStaticContext_defineSystemFunction("substring-before", [
        ...
        return new cXSString((nPosition = sValue.indexOf(sSearch)) >= 0 ? sValue.substring(0,
                                                                                           nPosition)
                                 : '');
    });
    ...
    fStaticContext_defineSystemFunction("substring-after", [
        ...
        return new cXSString((nPosition = sValue.indexOf(sSearch)) >= 0 ? sValue.substring(nPosition
                                                                                               + sSearch.length)
                                 : '');
    });
    ...
    function fFunction_string_createRegExp(sValue, sFlags) {
        ...
        if (bFlagS || bFlagX) {
            ...
            var aValue = [],
                rValue = /\s/;
            for (var nIndex = 0, nLength = sValue.length, bValue = false, sCharCurr, sCharPrev = '';
                 nIndex < nLength; nIndex++) {
    ...
    fStaticContext_defineSystemFunction("matches", [
        ...
        var sValue = oValue == null ? '' : oValue.valueOf(),
            rRegExp = fFunction_string_createRegExp(oPattern.valueOf(),
                                                    arguments.length > 2 ? oFlags.valueOf() : '');
    ...
    fStaticContext_defineSystemFunction("replace", [
        ...
        var sValue = oValue == null ? '' : oValue.valueOf(),
            rRegExp = fFunction_string_createRegExp(oPattern.valueOf(),
                                                    arguments.length > 3 ? oFlags.valueOf() : '');
    ...
    fStaticContext_defineSystemFunction("tokenize", [
        ...
        var oSequence = [];
        for (var nIndex = 0, aValue = sValue.split(rRegExp), nLength = aValue.length;
             nIndex < nLength; nIndex++) {
    ...
    cLXDOMAdapter.prototype.getProperty = function (oNode, sName) {
        ...
        if (sName == "baseURI") {
            var sBaseURI = '',
                fResolveUri = oLXDOMAdapter_staticContext.getFunction('{'
                                                                          + "http://www.w3.org/2005/xpath-functions"
                                                                          + '}' + "resolve-uri"),
                cXSString = oLXDOMAdapter_staticContext.getDataType('{'
    ...
    cLXDOMAdapter.prototype.compareDocumentPosition = function (oNode, oChild) {
        ...
        if (oAttr1 && oAttr2 && oNode && oNode == oChild) {
            for (nIndex = 0, aAttributes = this.getProperty(oNode, "attributes"), nLength =
                                                                                  aAttributes.length;
                 nIndex < nLength; nIndex++) {
        ...
        if (((oNode.ownerDocument || oNode) != (oChild.ownerDocument || oChild))
            || (aChain1[aChain1.length - 1] != aChain2[aChain2.length - 1])) {
            return 32 | 1;
        }
        for (nIndex = cMath.min(nLength1 = aChain1.length, nLength2 = aChain2.length); nIndex;
             --nIndex) {
            if ((oNode1 = aChain1[--nLength1]) != (oNode2 = aChain2[--nLength2])) {
                ...
                for (oElement = oNode2.previousSibling; oElement;
    ...
    cLXDOMAdapter.prototype.lookupNamespaceURI = function (oNode, sPrefix) {
        ...
        for (; oNode && oNode.nodeType != 9; oNode = oNode.parentNode) {
            ...
            else if (oNode.nodeType
                == 1) {
                for (var oAttributes = this.getProperty(oNode,
                                                        "attributes"), nIndex = 0, nLength = oAttributes.length, sName = "xmlns"
                                                                                                                             + ':'
                    + sPrefix; nIndex < nLength; nIndex++) {
        ...
        (function (oNode) {
            for (var nIndex = 0, oChild; oChild = oNode.childNodes[nIndex]; nIndex++) {
                if (oChild.nodeType == 1) {
                    if ((bLocalName || sLocalName == this.getProperty(oChild, "localName"))
                        && (bNameSpaceURI || sNameSpaceURI == this.getProperty(oChild,
                                                                               "namespaceURI"))) {
    ...
    oMSHTMLDOMAdapter.getProperty = function (oNode, sName) {
        ...
        if (sName == "attributes" && oNode.nodeType == 1) {
            var aAttributes = [];
            for (var nIndex = 0, oAttributes = oNode.attributes, nLength = oAttributes.length, oNode2, oAttribute;
                 nIndex < nLength; nIndex++) {
    ...
    var cHTMLDocument = window.HTMLDocument,
        ...
        bOldMS = !!oDocument.namespaces && !oDocument.createElementNS, bOldW3 = !bOldMS
            && oDocument.documentElement.namespaceURI != "http://www.w3.org/1999/xhtml";
    ...
    function fXPath_evaluate(oQuery, sExpression, fNSResolver) {
        ...
        var oStaticContext = oNode && (oNode == oDocument || oNode.ownerDocument == oDocument)
            ? oHTMLStaticContext : oXMLStaticContext;
        ...
        aSequence =
        oExpression.evaluate(new cDynamicContext(oStaticContext, oNode, null, oAdapter));
        for (var nIndex = 0, nLength = aSequence.length, oItem; nIndex < nLength; nIndex++) {
            oSequence.push(oAdapter.isNode(oItem = aSequence[nIndex]) ? oItem
                               : cStaticContext.xs2js(oItem));
        }
    ...
    oObject.xpath = function (oQuery, sExpression, fNSResolver) {
        return fXPath_evaluate(oQuery instanceof cQuery ? oQuery : new cQuery(oQuery), sExpression,
                               fNSResolver);
    };
